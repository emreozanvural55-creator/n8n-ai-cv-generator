...
- **ATS Formatına Dönüştürme:** CV içeriğinin ATS yazılımlarına en uygun biçimde yeniden yapılandırılması.
- **HTML to PDF Render:** Hazırlanan Markdown çıktısının HTML'e, ardından indirebilir PDF formatına dönüştürülmesi.
